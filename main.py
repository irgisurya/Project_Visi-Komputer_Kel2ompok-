...
sound = pyglet.media.load(r"C:\Users\HP\OneDrive\Documents\Kuliah\Deteksi Kelelahan/alarm.wav", streaming=False)
...
while True:
    ...
    if faces:
        ...
        cv2.rectangle(img, (30, 200), (250, 300), (255,0,0), cv2.FILLED)
        cv2.putText(img, f'Kantuk: {counter_s}', (40, 240),
                    cv2.FONT_HERSHEY_PLAIN, 2, (255,255,255), 2)
        cv2.putText(img, f'Menguap: {counter_y}', (40, 280),
                    cv2.FONT_HERSHEY_PLAIN, 2, (255, 255, 255), 2)

        cv2.rectangle(img, (30,20), (200,150), (0,255,255), cv2.FILLED)
        cv2.putText(img, f'RMI: {eyeLeft_ratio}', (50, 60),
                    cv2.FONT_HERSHEY_PLAIN, 2, (255,0,0), 2)
        cv2.putText(img, f'RMA: {eyeRight_ratio}', (50, 100),
                    cv2.FONT_HERSHEY_PLAIN, 2, (255, 0, 0), 2)
        cv2.putText(img, f'RM: {mouth_ratio}', (50, 140),
                    cv2.FONT_HERSHEY_PLAIN, 2, (255, 0, 0), 2)
